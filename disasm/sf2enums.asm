...
ALLYBATTLEANIMATION_DODGES_START: equ $50
ALLYBATTLEANIMATION_SPECIALS_START: equ $A0
ALLYBATTLEANIMATION_SPECIAL_SPEARTHROW_KNTE: equ $A0
ALLYBATTLEANIMATION_SPECIAL_SPEARTHROW_PLDN: equ $A1
ALLYBATTLEANIMATION_SPECIAL_SPEARTHROW_PGNT: equ $A2
ALLYBATTLEANIMATION_SPECIAL_MMNK: equ $A3
ALLYBATTLEANIMATION_SPECIAL_MNST: equ $A4
ALLYBATTLEANIMATION_SPECIAL_RBT: equ $A5
ALLYBATTLEANIMATION_SPECIAL_BRGN: equ $A6
...
ENEMYBATTLEANIMATION_SPECIALS_START: equ $F4
ENEMYBATTLEANIMATION_SPECIAL_HELL_HOUND: equ $F4
ENEMYBATTLEANIMATION_SPECIAL_DEVIL_GRIFFIN: equ $F5
ENEMYBATTLEANIMATION_SPECIAL_ODD_EYE: equ $F6
